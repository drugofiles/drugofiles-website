...
const macroAreas = [
  ...
  },
  {
    ...
    thumbnail: "/projects/Natassja1.jpg",
    order: 3
  }
];
...
async function main() {
  ...
  const projectsData = [
    // 1. Alba Pluma (Commercial, Featured)
    {
      ...
      objective: "L'obiettivo del progetto con AlbaPluma era creare un video di lancio dinamico, per rappresentare il brand e i suoi valori. Eleganza, comfort, leggerezza.",
    ...
    // 4. LA STORIA DI BETTA (Entertainment, Featured)
    {
      ...
      objective: 'Il progetto aveva un obiettivo molto preciso, raccontare la storia di betta ed entrare nei cuori. Ragazze e ragazzi adoloscenti sin da subito era il target principale, considerando che la canzone parla di una ragazzina di 14 anni.',
    ...
    // 6. Coffee Machine (Commercial)
    {
      ...
      objective: "L'obiettivo era semplice, ma allo stesso tempo complesso: l'eleganza.",
    ...
    // 7. Matrimonio di Fabrice & Silvia (Premium, Featured)
    {
      ...
      objective: "L'obiettivo di un video matrimoniale non è solo documentare, ma di emozionare e durare nel tempo.",
    ...
    // 8. Sono Wisee (Entertainment)
    {
      ...
      mockupVideos: [],
      objective: "L'obiettivo principale del progetto musicale, non era solo la musica, ma l'aumento del pubblico. Video verticali, strutturati appositamente per colpire il pubblico target e andare virali.",
    ...
    // 12. Scuola di danza (Commercial)
    {
      ...
      objective: "L'obiettivo era trasmettere l'amore per la danza ad un pubblico più ampio sfruttando video cinematografici e commuoventi.",
    ...
    // 13. That's Amore (Commercial, Featured)
    {
      ...
      objective: "L'obiettivo della collaborazione di That's Amore e Drugofiles era quello di usare il contenuto media per diffondere la nuova realtà afro.",
    ...
    // 14. Berraquera (Entertainment)
    {
      ...
      objective: "L'obiettivo del progetto con Sabrina era quello di creare un video musicale che rappresenta la canzone. Sole, mare e felicità.",
    ...
    // 16. Matrimonio Natassja & Vincenzo (Premium, Featured)
    {
      title: 'Matrimonio Natassja & Vincenzo',
      slug: 'Natassja-Vincenzo',
      client: 'Natassja-Vincenzo',
      year: 2026,
      tagline: 'Ritrovati nel tempo',
      thumbnail: '/projects/Natassja1.jpg',
      localVideo: '/videos/NatassjaVideo1.mp4',
      objective: "L'obiettivo era trasmettere l'amore che attrae, riunisce e fa sorridere.",
      description: 'Il video che racconta la storia di Natassja e Vincenzo, che si ritrovano e si uniscono in matrimonio a quasi 18 anni dal loro primo incontro. Video create in collaborazione con Righello.',
      results: 'Video emozionanti, cinematografici e realistici. In questo caso il video non serve solo a rivivere il giorno del matrimonio, ma l\'intera storia d\'amore di Natassja e Vincenzo.',
      objectiveMedia: ['NatassjaVideo2'],
      galleryImages: ['Natassja2', 'Natassja3', 'Natassja4', 'Natassja5'],
      tags: ['Matrimonio', 'video', 'Righello'],
      featured: true,
      macroAreaId: premiumArea!.id,
    },
    // 17. L'unione civile dei sindaci (Premium, Featured)
    {
      title: "L'unione civile dei sindaci",
      slug: 'Sindaci',
      client: 'Alessandro Basso e Loris Bazzo',
      year: 2026,
      tagline: 'Carlino & Pordenone',
      thumbnail: '/projects/Sindaci1.jpg',
      localVideo: '/videos/SindaciVideo1.mp4',
      objective: "L'obiettivo del progetto era consegnare agli sposi non solo un ricordo della giornata, ma anche una documentazione audiovisiva dell'evento storico e politico.",
      description: 'L\'unione civile dei sindaci di centrodestra. Loris Bazzo e Alessandro Basso a Villa Cattaneo. Il video documenta in modo organico e cinematografico i highlights della giornata. Progetto in collaborazione con Righello.',
      results: 'Video che rappresenta la grandezza e l\'importanza dell\'evento con le tonalità calde ed emotive.',
      objectiveMedia: ['Sindaci2'],
      descriptionMedia: ['Sindaci3'],
      resultMedia: ['Sindaci4'],
      tags: ['Matrimonio', 'video', 'Righello'],
      featured: true,
      macroAreaId: premiumArea!.id,
    },
    // 18. Matrimonio Lina & Roberto (Premium, Featured)
    {
      title: 'Matrimonio Lina & Roberto',
      slug: 'Lina-Roberto',
      client: 'Lina e Roberto',
      year: 2026,
      tagline: 'Italian Style',
      thumbnail: '/projects/Lina1.jpg',
      localVideo: '/videos/LinaVideo4.mp4',
      objective: 'Il desiderio degli sposi non era semplicemente un video ricordo bello ed emozionante: ciò che desideravano era anche una serie di contenuti extra da condividere con amici e parenti e da pubblicare sui social.',
      description: 'Matrimonio in stile italiano tra due sposi giovani e vivaci. I contenuti video rispecchiano pienamente la giornata e il suo mood.',
      results: 'Un pacchetto di video emozionanti e di impatto. Contenuti degni di essere rivisti e ripubblicati.',
      objectiveMedia: ['LinaVideo1_v'],
      descriptionMedia: ['LinaVideo2'],
      resultMedia: ['LinaVideo3'],
      tags: ['Matrimonio', 'video', 'social'],
      featured: true,
      macroAreaId: premiumArea!.id,
    },
    // 19. Tira su le mani (Entertainment, Featured)
    {
      title: 'Tira su le mani',
      slug: 'Loris-Tira-su-le-mani',
      client: 'Loris',
      year: 2026,
      tagline: 'Questa è codroipo',
      thumbnail: '/projects/Ambulanza1.jpg',
      localVideo: '/videos/AmbulanzaVideo1.mp4',
      objective: "L'obiettivo era dare forma, attraverso l'ironia, a un messaggio già radicato nella mente del pubblico, inserendolo in un contesto molto serio.",
      description: 'Loris non è mai stato un artista semplice. In questo video musicale comico, realizzato insieme a Loris, abbiamo inserito diversi riferimenti all\'attualità, sia di carattere politico sia legati al business musicale. Questo è uno di quei progetti che si è sviluppato soprattutto nella fase di pre-produzione.',
      results: 'Più di 3 milioni di views totali. Video finito su Rai 3. Interviste in TG.',
      viewsAfter: 2000000,
      objectiveMedia: ['AmbulanzaVideo2'],
      descriptionMedia: ['AmbulanzaVideo3'],
      resultMedia: ['Ambulanza2'],
      tags: ['Music', 'VideoMusicale', 'Cinematografico'],
      featured: true,
      macroAreaId: entertainmentArea!.id,
    },
